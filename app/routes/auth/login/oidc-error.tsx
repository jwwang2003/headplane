  ...
  return (
    <Card className="m-4 mb-4 max-w-md border border-red-500 sm:m-0 sm:mb-4">
      <div className="flex items-center justify-between gap-4">
        <Card.Title className="text-red-500">{t("Configuration Issue(s)")}</Card.Title>
...
function getErrorMessage(code: string, t: Translate) {
  switch (code) {
    case "error_no_query":
      return (
        <Card.Text>
    ...
    default:
      return (
        <Card.Text>
          {t("An unknown error occurred during OIDC authentication. Please try again later.")}
        </Card.Text>
      );
  }
}
