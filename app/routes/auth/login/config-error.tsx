  ...
  return (
    <Card className="m-4 mb-4 max-w-md border border-yellow-500 sm:m-0 sm:mb-4">
      <div className="flex items-center justify-between gap-4">
        <Card.Title className="text-yellow-500">
          <T text={"SSO Temporarily Unavailable"} />
        </Card.Title>
    ...
    <Card className="m-4 mb-4 max-w-md border border-red-500 sm:m-0 sm:mb-4">
      <div className="flex items-center justify-between gap-4">
        <Card.Title className="text-red-500">
          <T text={"Authentication Error"} />
        </Card.Title>
        <AlertCircle className="mb-2 h-6 w-6 text-red-500" />
      </div>
      <Card.Text className="text-sm">
        <T text={"The OpenID Connect (OIDC) Single Sign-On (SSO) configuration has issues:"} />{" "}
        ...
        messages.push({
          ...
          node: (
            <Card.Text className="inline">
              <T text={"The provided API key for OIDC authentication is invalid. Ensure that"} />{" "}
              <Code>headscale.api_key</Code> <T text={"is a valid API key."} />
            </Card.Text>
          ),
        });
        break;
